            ...
            <div class="col-md-6 login-form-1">
                ...
                <?php if (isset($_GET['loginerror'])) { ?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>Alert !</strong> <?php echo $_GET['loginerror']; ?>
            ...
            <div class="col-md-6 login-form-2">
                ...
                <form method="POST" action="Query.php">
                    ...
                    <div class="form-group">
                        <select class="form-control" name="rolessystem" required>
                            ...
                            $result  = mysqli_query($connection, $rolesfetchQuery);
                ...
                if (isset($_GET['successregistration'])) { ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Congratulation !</strong> <?php echo $_GET['successregistration']; ?>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
if (isset($_REQUEST['btnlogin'])) {
    ...
    $result  = mysqli_query($connection, $sqlquerycheckrecord);
